...
fsel() {
  local cmd="${SKIM_CTRL_T_COMMAND:-"command fd -L . -mindepth 1 \\( -path '*/\\.*' -o -fstype 'sysfs' -o -fstype 'devfs' -o -fstype 'devtmpfs' -o -fstype 'proc' \\) -prune \
    -o -type f -print \
    -o -type d -print \
...
skim-cd-widget() {
  local cmd="${SKIM_ALT_C_COMMAND:-"command fd -L . -mindepth 1 \\( -path '*/\\.*' -o -fstype 'sysfs' -o -fstype 'devfs' -o -fstype 'devtmpfs' -o -fstype 'proc' \\) -prune \
